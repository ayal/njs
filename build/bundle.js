...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
				...
				setval: function setval(name, val) {
							...
							var q = this.props.location.query;
							q[name] = val;
							that.context.router.push({ pathname: '', q: q });
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  margin: 0;\n}\nhtml,\nbody,\n#content {\n  height: 100%;\n}\nbody {\n  font-family: 'Montserrat', sans-serif;\n  color: #555;\n  background: #ddd;\n  overflow-x: hidden;\n  overflow: auto;\n}\na {\n  color: inherit;\n  cursor: pointer;\n}\n.nav-trigger {\n  position: absolute;\n  clip: rect(0, 0, 0, 0);\n}\nlabel[for=\"nav-trigger\"] {\n  position: absolute;\n  z-index: 2;\n  display: block;\n  height: 30px;\n  width: 30px;\n  cursor: pointer;\n  background-image: url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1' x='0px' y='0px' width='30px' height='30px' viewBox='0 0 30 30' enable-background='new 0 0 30 30' xml:space='preserve'><rect width='30' height='6'/><rect y='24' width='30' height='6'/><rect y='12' width='30' height='6'/></svg>\");\n  background-size: contain;\n  margin: 10px;\n}\n.nav-trigger:checked + label {\n  left: 215px;\n}\n.nav-trigger:checked ~ .frames {\n  left: 200px;\n  box-shadow: 0 0 5px 5px rgba(0, 0, 0, 0.5);\n}\n.app {\n  height: 100%;\n}\n.app .filters {\n  min-height: 100%;\n  padding: 30px;\n  background: #444;\n  color: #ddd;\n  width: 100%;\n  position: fixed;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: 0;\n}\n.app .filters .filter {\n  padding: 10px;\n}\n.app .filters .filter div {\n  margin-bottom: 6px;\n}\n.app .filters .filter input {\n  background: inherit;\n  border: none;\n  outline: none;\n  border-bottom: 1px solid #ddd;\n  color: #ddd;\n  font-size: 14px;\n  line-height: 14px;\n}\n.app .filters .logop {\n  color: pink;\n  cursor: pointer;\n}\n.app .frames {\n  min-height: 100%;\n  position: relative;\n  top: 0;\n  bottom: 100%;\n  left: 0;\n  z-index: 1;\n  background: #ddd;\n  flex-direction: column;\n  padding: 50px;\n}\n.app .frames .list {\n  overflow: auto;\n  display: flex;\n  flex-wrap: wrap;\n}\n.app .frames .list .frame {\n  cursor: pointer;\n  position: relative;\n  max-width: 300px;\n  max-height: 300px;\n  padding: 10px;\n  border: 2px solid white;\n  margin: 4px;\n  flex: 1;\n}\n.app .frames .list .frame .content {\n  max-width: 200px;\n  max-height: 200px;\n  min-width: 200px;\n  min-height: 200px;\n  overflow: hidden;\n}\n.app .frames .list .frame .content img {\n  width: 200px;\n}\n.app .frames .list .frame a {\n  position: absolute;\n  bottom: 10px;\n  left: 10px;\n  color: #6bd16b;\n}\n.app .frames .list .frame .money {\n  position: absolute;\n  bottom: 10px;\n  right: 10px;\n  font-size: 20px;\n  color: #6bd16b;\n}\n", ""]);
